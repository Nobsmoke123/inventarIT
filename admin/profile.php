                        ...
                        <div class="ibox-content">
                            <form action="index.php" method="POST" class="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" disabled value="<?php echo $profile_details["username"]; ?>">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="email" value="<?php echo $profile_details["email"]; ?>">
                                    </div>
                                </div>
