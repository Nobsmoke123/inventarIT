...
<body>
            ...
            <div class="wrapper wrapper-content">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                                ...
                                <tbody>
                                    <?php for($i = 0; $i < count($customers); $i++): ?>
                                        <tr class="gradeX">
                                            ...
                                            <td class="text-center">
                                                <?php echo $customers[$i]["phone"]; ?>
                                            </td>
                                            <td class="text-center">
                                                <?php echo $customers[$i]["jobs_count"]; ?>
                                            </td>
                                            <td class="text-center">
                                                <div class="row">
                                                    <div class="col-sm-12 col-md-12 <col-lg-12></col-lg-12>">
                                                        <a href="#" onclick="addCustomerIdValue(<?php echo $customers[$i]["id"];?>);" data-toggle="modal" data-target="#myModal">
                        ...
                        <!--Modal for editing the Customer details  -->
                        <!-- Modal -->
                                ...
                                <div class="modal-content">
                                    <form action="index.php" method="post">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title text-center" id="myModalLabel"> Update Customer Details </h4>
                                        </div>
    ...
    <script>
        ...
        function addCustomerIdValue(customer_id){
